...
class RideBookTab extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            const Text('Where to?', style: TextStyle(fontFamily: 'Urbanist', fontSize: 20, fontWeight: FontWeight.w700)),
            const SizedBox(height: 20),
            // Pickup
            GestureDetector(
              onTap: () => context.push(AppRoutes.rideDestination),
              child: Container(
            ...
            CustomAppButton(
              title: 'Find Rides',
              onPressed: () => context.push(AppRoutes.bookRide),
            ),
          ],
        ),
      ),
